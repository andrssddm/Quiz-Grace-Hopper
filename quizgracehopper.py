...
# ---------------- RESULTADO FINAL ----------------
    ...
    if st.session_state.total >= 80:
        ...
        st.info("Você foi muito bem no quiz! Mostrou que já conhece grande parte da trajetória de Grace Hopper.")
    elif st.session_state.total >= 20:
        st.warning("Você está no caminho certo! Já conhece alguns fatos importantes sobre Grace Hopper.")
    else:
        st.error("Não se preocupe! Estude mais e tente novamente para ver sua evolução.")
